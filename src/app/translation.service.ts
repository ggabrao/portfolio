...
export class TranslationService {
  ...
  private translations: Translations = {
    pt: {
      ...
      exTitle: 'Experiência',
      exDesc: 'Fullstack na área de desenvolvimento web, com foco em Frontend.',
      grad: 'Graduação',
      gradDesc: 'em Engenharia Civil (UFG)',
      pos: 'Pós-Graduação',
      ...
      d1: 'HTML, CSS, JS, pré-processadores CSS, design responsivo e acessibilidade.',
      ...
      t5: 'Laravel',
      d5: 'Aplicação em projetos fullstack utilizando Blade e ferramentas do ecossistema (Breeze, Herd, Valet).',
      ...
      pd1: 'Projeto para consolidar a especialização no Framework e nos básicos de Frontend e Web Design.',
      plink: 'Visitar',
    ...
    en: {
      ...
      exTitle: 'Experience',
      exDesc: 'Full-stack web development, with focus on Frontend.',
      grad: 'Graduation degree',
      gradDesc: 'in Civil Engineering (UFG)',
      ...
      d1: 'HTML, CSS, JS, CSS preprocessors, responsive design and accessibility.',
      t2: 'Agile',
      ...
      pd1: 'Project to consolidate the specialization in the Framework and Frontend/Web Design basics.',
      plink: 'Visit project',
